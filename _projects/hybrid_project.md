...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/proj_hybrid/2robot.png" title="2robot" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/proj_hybrid/3robot.png" title="3robot" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
