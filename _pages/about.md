...
I just completed an 8-month internship at the NASA Jet Propulsion Laboratory (JPL) investigating novel locomotion methods for future lunar rovers. My related paper on optimal gait transitions can be read here: [Trajectory Optimization Methods for Energy Efficient Gait Transitions on Multi-Modal Robots](https://www.minh02.com/assets/pdf/NguyenTrajectoryOptimization.pdf) which is to be presented at [IEEE Aerospace 2024](https://www.aeroconf.org/).
